(function(global,doc){ 'use strict';
  ...
  global.Annotater.prototype = {
      ...
      name:          null,
      nameBecomes:   '<span class="dashed">{name}</span>',
      tooltip:       null,
          ...
          for(var nodeNum in this._vars){
              ...
              if( this.tooltip ){
                  ...
                  if(this.autoStyle){
                      ...
                      item.toolTip.style.transitionDuration = '.25s';
                      item.toolTip.style.position = 'absolute';
                      item.toolTip.style.background = 'rgba(248, 228, 214, 0.93)';
                      item.toolTip.style.pointerEvents = 'none';
                      item.toolTip.style.padding = '5px';
